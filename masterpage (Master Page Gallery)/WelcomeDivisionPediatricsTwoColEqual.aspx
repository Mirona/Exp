...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	...
	<div id="divisionHomeBottom">
		...
		<div id="homeColumnLeft" class="twoColEqual">
			<h1>&nbsp;<SharePoint:TextField FieldName="Column_x0020_Title_x0020_Left" runat="server"></SharePoint:TextField></h1>
		...
		<div id="homeColumnRight" class="twoColEqual">
			<h1>&nbsp;<SharePoint:TextField FieldName="Column_x0020_Title_x0020_Right" runat="server"></SharePoint:TextField></h1>
			<div class="lineBreak"></div>
